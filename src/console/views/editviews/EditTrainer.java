...
public class EditTrainer {
    ...
    private static void chooseEditor(){
        ...
        Trainer chosenTrainer = OtherViews.trainerChoose.chooseOne(data.getTrainers()); // Lets the user to choose one trainer
    ...
    private static void subjectEditor(Trainer trainer){
        ...
        Style.printFormatted(new int[]{45,20}, new String[]{Style.yellow("CURRENT TRAINER'S SUBJECT: "), trainer.getLastName()});
        Style.addUnderline();
        Style.addLines(1);
        System.out.println(Style.yellow("WRITE THE NEW LAST NAME: "));
