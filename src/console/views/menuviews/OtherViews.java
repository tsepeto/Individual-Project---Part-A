...
public class OtherViews {
    ...
    public static void closeProgram(){
        ...
        System.out.println(Style.blue("  ________________")+Style.yellow("/\\\\\\/")+Style.blue("_____________")+Style.yellow("/\\\\\\/__\\///\\\\\\")+Style.blue("____")+Style.yellow("/\\\\\\/")+Style.blue("__")+Style.yellow("\\///\\\\\\")+Style.blue("__")+Style.yellow("\\/\\\\\\")+Style.blue("_____________      "));
