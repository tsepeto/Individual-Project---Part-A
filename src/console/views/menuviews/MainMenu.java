 ...
 */
    public static void showMenu(){
        ...
        do{
            ...
            System.out.println(Style.yellow("4")+" - EXIT THE PROGRAM");
            Style.addUnderline();
            
            Style.addLines(1);
            
            result = Input.giveOnlyInteger(1,4);
            switch(result){
            
            case 1:
                ObjectMenu.showFor(DataBase.viewFor.CREATE);                    //Calls the next View and tells it that the
                break;                                                          //user wants to create an object.
                
            case 2:
                ObjectMenu.showFor(DataBase.viewFor.EDIT);                      //Calls the next View and tells it that the
                break;                                                          //user wants to edit an object.
                
            case 3:
                ObjectMenu.showFor(DataBase.viewFor.SEARCH);                    //Calls the next View and tells it that the
